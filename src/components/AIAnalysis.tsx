    ...
    <div className="bg-card border border-border rounded-xl p-6 shadow-sm mb-6 relative overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          disabled={loading}
          className="bg-accent hover:bg-accent/90 text-white font-medium py-2 px-4 rounded-lg transition-colors flex items-center gap-2 disabled:opacity-50"
        >
      ...
      <AnimatePresence mode="wait">
        {!analysis && !loading && (
          <motion.div 
            ...
            className="text-center py-12 text-muted-foreground bg-muted/50 rounded-xl border border-dashed border-border"
          >
        ...
        {loading && (
          ...
          >
            ...
            <div className="space-y-4">
               ...
               <div className="h-32 bg-muted animate-pulse rounded-xl border-l-4 border-accent" />
            </div>
          </motion.div>
        )}
        ...
        {analysis && !loading && (
          ...
          >
              ...
              <div>
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {analysis.recommendations.map((rec, idx) => (
                      <div key={idx} className="bg-card border border-border p-4 rounded-xl flex flex-col gap-2">
            ...
            <div className="space-y-4 lg:pl-4 lg:border-l border-border">
              ...
              <div className="bg-accent/5 border-l-4 border-accent p-4 rounded-xl relative overflow-hidden">
